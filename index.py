...
<body>
  ...
  <h4>먼 미래의 목표</h4>
  <ul>
    <li>닌자 사이트와 연동되는 시세차익표 작성</li>
    <li>엑셀에 있는 자료 옮겨오고 전체적인 리뉴얼</li>
  </ul>
  <h4>비주얼 스튜디오 코드 단축키</h4>
  <div>
    <ul>
      <li>컨트롤+k, 컨트롤+0 : 전체접기</li>
      <li>컨트롤+k, 컨트롤+j : 전체펴기</li>
  ...
  <div style="font-size: 12px;">
    2020년 6월 15일 - 자바스크립트 기초강좌 1차완강<br><br>
    2020년 6월 11일 - 파이썬 기초강좌 1차완강<br><br>
    2020년 5월 23일 - 파이썬 실습환경 조성<br><br>
    2020년 5월 18일 - 트위치 주소변환 조정<br><br>
    2020년 5월 16일 - 트위치 주소변환 만들어보기 목표 달성<br><br>
    2020년 5월 15일 - 목차를 자바스크립트 파일로 추출해서 정리<br><br>
    2020년 5월 14일 - 목차에 반복과 배열문 적용(처음으로 습득한 지식을 다른 부분에 활용한 사례)<br><br>
    2020년 5월 10일 - 본격적 작업 시작<br><br>
  </div>  
